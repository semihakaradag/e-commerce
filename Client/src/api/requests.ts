...
const queries = {
    ...
    post: (url: string, body: unknown) => axios.post(url, body).then((response: AxiosResponse) => response.data), 
    put: (url: string, body: unknown) => axios.put(url, body).then((response: AxiosResponse) => response.data), 
